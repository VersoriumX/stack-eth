...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/83029b82c3804348b9ba14ddd6a604cf", // <---- YOUR INFURA ID! (or it won't work)
    ...
    kovan: {
      url: "https://kovan.infura.io/v3/83029b82c3804348b9ba14ddd6a604cf", // <---- YOUR INFURA ID! (or it won't work)
    ...
    mainnet: {
      url: "https://mainnet.infura.io/v3/83029b82c3804348b9ba14ddd6a604cf", // <---- YOUR INFURA ID! (or it won't work)
    ...
    ropsten: {
      url: "https://ropsten.infura.io/v3/83029b82c3804348b9ba14ddd6a604cf", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://goerli.infura.io/v3/83029b82c3804348b9ba14ddd6a604cf", // <---- YOUR INFURA ID! (or it won't work)
  ...
  etherscan: {
    apiKey: "ZTJ2XP61IB7PQR4IVSQ63TFXBQ7GXKYDHU",
  },
};
